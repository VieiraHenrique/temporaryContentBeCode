...
There is such a builtin module to node called `os`
...
You might have noticed that the state of the folders/files will either work or through an error. So write a little program that tests each time "if the folder exists, then... else..."
